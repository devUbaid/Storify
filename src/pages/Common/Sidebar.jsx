...
function Sidebar({ data2, data }) {
  ...
  return (
    <div className="sideBar w-[18%] md:w-[10%] lg:w-[15%] font-inter bg-[#072020] top-14 md:top-16 lg:top-20 px-2 h-full fixed overflow-y-auto">
      <ul className="w-full flex flex-col items-center">
        ...
        >
          ...
          >
            ...
            <p className=" hidden lg:block p-1 w-full">My Store</p>
          </Link>
        </li>
      ...
      <hr />
      <div className="storage  lg:p-2 w-full listSideNormal bg-[#004646] ">
