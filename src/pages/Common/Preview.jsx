...
function Preview({ preview, dataPreview ,toggleShared}) {
  ...
  return (
    <div className="w-[100vw] h-[100vh] top-0 right-0 fixed flex flex-col z-50 bg-[#0000007e] overflow-hidden font-inter text-white items-center">
      <div className="previewNav w-[85%]  flex justify-between items-center px-2  h-14 md:h-16 lg:h-20">
        <button onClick={handleClose}>
          <img src="/Logo/close.svg" alt="Close button" className="w-7 md:w-8 lg:w-10" />
        </button>
