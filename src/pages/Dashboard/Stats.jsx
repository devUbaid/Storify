...
function Stats({ data ,data2}) {
  ...
  return (
    <div className='lg:p-8 p-1 w-full  grid grid-cols-2 gap-3 md:gap-3 md:grid-cols-3 lg:grid-cols-4   font-inter'>
      {datas.map((item, i) => (
        <div key={i} className='bg-[#d3d2cd6b] cursor-pointer rounded-lg md:rounded-xl lg:rounded-[20px] p-2  lg:p-4 flex-col  hover:scale-105 duration-200 transition-all'>
